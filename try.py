    ...
    if location:
        ...
        if current_weather and forecast_data:
            ...
            if recommendations:
                ...
                st.markdown(
        "<div style='color:#111; font-size:1.1rem;'>🌱 <b>Optimal Conditions</b>: Current weather conditions are favorable for most agricultural activities. Continue with regular monitoring.</div>",
        unsafe_allow_html=True
    )
        ...
        unsafe_allow_html=True
                ...
                st.markdown(
        "<div style='color:#111; font-size:1.1rem;'>✅ No significant weather alerts for the next 24 hours.</div>",
        unsafe_allow_html=True
    )       
